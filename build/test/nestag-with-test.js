...
/*! Nestag 0.0.6 //// MIT Licence //// http://nestag.richplastow.com/ */
(function(global) {
...
oo.V = "0.0.6" // project version, from package.json


/*! Nestag 0.0.6 */
var Location, Nestag, TAG_RULE, Tudor, global_tags, tudor,
...
tudor.add([
  "02 Location::browse()", tudor.is, "`browse()` is a function which returns a string or an array", function() {
    return [
      new Location({
        coord: 'a'
      })
  ...
  }, tudor.equal, "For an empty Location instance, `browse()` returns the string '[empty]'", '[empty]', function(location) {
    return location.browse();
