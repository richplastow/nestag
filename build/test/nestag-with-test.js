...
/*! Nestag 0.0.9 */
var COORD_RULE, Location, Nestag, TAG_RULE, Tudor, drawBorder, drawBox, global_tags, tudor,
...
Tudor = (function() {
  ...
  Tudor.prototype["do"] = function() {
    var actual, art, artFail, artPass, article, e, error, expect, heading, job, k, len, len1, len2, m, mock, mockFail, o, pge, pgeFail, pgePass, ref, ref1, ref2, result, runner, sec, secFail, secPass, section, summary;
    pge = [];
    mock = [];
...
tudor.add([
  "01 Location Constructor", tudor.is, "The class and instance are expected types", function() {
    return [
      new Location({
        nestag: new Nestag,
        coord: 'a'
...
tudor.add([
  "02 Nestag Constructor", tudor.is, "The class and instance are expected types", function() {
    return [new Nestag];
    ...
    return nestag + '';
  }, "Default instance properties as expected", tudor.equal, "`Nestag::grid` is the array `[2,2]`", '2x2', function(nestag) {
    return nestag.grid.join('x');
  }, "`Nestag::nest` is the number `9999`", 9999, function(nestag) {
    return nestag.nest;
  }, "`Nestag::scheme` is the string 'continuous'", 'continuous', function(nestag) {
    return nestag.scheme;
  }, "`Nestag::form` is the string 'short'", 'short', function(nestag) {
    return nestag.form;
  }, "`Nestag::_locations` is private, and is an empty object", 0, function(nestag) {
    return Object.keys(nestag[oo._]._locations).length;
  }, "`config` usage", "`config.grid` takes an array of integers", '3x3x3', function() {
    var n;
    n = new Nestag({
      grid: [3, 3, 3]
    });
    return n.grid.join('x');
    ...
    return n.nest;
  }, "`config.scheme` can be 'continuous' or 'dimensional'", 'continuous or dimensional', function() {
    var n1, n2;
    n1 = new Nestag({
      scheme: 'continuous'
    });
    ...
    return n1.scheme + ' or ' + n2.scheme;
  }, "`config.form` can be 'long' or 'short'", 'long or short', function() {
    var n1, n2;
    n1 = new Nestag({
      form: 'long'
    });
  ...
  }, "`config.scheme` exceptions", tudor["throw"], "`config.scheme` is a regexp", "/nestag/src/Nestag.litcoffee Nestag()\n  config.scheme is type regexp not string", function() {
    return new Nestag({
      scheme: /continuous/
    });
  }, "`config.scheme` is not a valid keyword (should be lowercase)", "/nestag/src/Nestag.litcoffee Nestag()\n  config.scheme fails ^continuous|dimensional$", function() {
    return new Nestag({
      scheme: 'CONTINUOUS'
    });
  }, "`config.form` exceptions", tudor["throw"], "`config.form` is an array", "/nestag/src/Nestag.litcoffee Nestag()\n  config.form is type array not string", function() {
    return new Nestag({
      form: ['l', 'o', 'n', 'g']
    });
  }, "`config.scheme` is not a valid keyword (should be lowercase)", "/nestag/src/Nestag.litcoffee Nestag()\n  config.form fails ^short|long$", function() {
    return new Nestag({
      form: 'Long'
    });
  }
...
tudor.add([
  "03 Location::browse()", tudor.is, "`browse()` is a function which returns a string or an array", function() {
    ...
    return [
      new Location({
        nestag: new Nestag,
        coord: 'abc',
        cargo: [null, new Nestag, {}, {}, 8].concat((function() {
          results = [];
          for (k = 1; k <= 200; k++){ results.push(k); }
          return results;
        }).apply(this))
      })
    ];
  ...
  }, tudor.equal, "For a Location with no Sub-Locations, `browse()` returns a box as expected", ".----.--------------------------------abc-------------------------------------.\n|x  1:                                                                        |\n|N  1:                                                                        |\n|o  2:                                                                        |\n|n201:                                                                        |\n|    :                                                                        |\n|    :                                                                        |\n|    :                                                                        |\n|    :                                                                        |\n|    :                                                                        |\n|    :                                                                        |\n|    :                                                                        |\n|    :                                                                        |\n|    :                                                                        |\n|    :                                                                        |\n|    :                                                                        |\n|    :                                                                        |\n|    :                                                                        |\n|    :                                                                        |\n|    :                                                                        |\n|    :                                                                        |\n|    :                                                                        |\n|    :                                                                        |\n'===='========================================================================'", function(location) {
    return location.browse();
  }, "...and `browse({format:'array'})` returns an empty array", 3, function(location) {
    return location.browse({
      format: 'array'
    }).length;
  ...
  }, "A 2x5 box as expected", "bc\n||\n||\n||\n''", function(location) {
    return location.browse({
      w: 2,
      h: 5
    });
  }, "A 4x4 box as expected", ".abc\n|  |\n|  |\n'=='", function(location) {
    return location.browse({
      w: 4,
      h: 4
    });
  }, "A 4x16 box as expected - too narrow for cargo/tags display", ".------abc-----.\n|              |\n|              |\n'=============='", function(location) {
    return location.browse({
      w: 16,
      h: 4
    });
  }, "A 3x17 box as expected - not high enough for cargo/tags display", ".------abc------.\n|               |\n'==============='", function(location) {
    return location.browse({
      w: 17,
      h: 3
    });
  }, "A 4x17 box as expected - just big enough to show partial cargo", ".----.-abc------.\n|x  1:          |\n|....:          |\n'===='=========='", function(location) {
    return location.browse({
      w: 17,
      h: 4
    });
  }, "A 6x17 box as expected - just big enough to show all cargo (no tags exist)", ".----.-abc------.\n|x  1:          |\n|N  1:          |\n|o  2:          |\n|n201:          |\n'===='=========='", function(location) {
    return location.browse({
      w: 17,
      h: 6
    });
  }, "A 7x17 box as expected - all cargo and one line of space (no tags exist)", ".----.-abc------.\n|x  1:          |\n|N  1:          |\n|o  2:          |\n|n201:          |\n|    :          |\n'===='=========='", function(location) {
    return location.browse({
      w: 17,
      h: 7
    });
...
tudor.add([
  "04 Nestag::browse()", tudor.is, "`browse()` is a function which returns a string or an array", function() {
    var nestag;
    nestag = new Nestag;
    nestag.add({
      cargo: ['Level 0']
    ...
    return [nestag];
  }, "`browse()` is a function", oo.F, function(nestag) {
    return nestag.browse;
  }, "`browse()` returns a string", oo.S, function(nestag) {
    return nestag.browse();
  }, "`browse({format:'array'})` returns an array", oo.A, function(nestag) {
    return nestag.browse({
      format: 'array'
    });
  }, tudor.equal, "For the initial test-instance, `browse({ w:20, h:5 })` returns a string...", ".--.---------------.\n|s1:               |\n|  :               |\n|  :               |\n'=='==============='", function(nestag) {
    return nestag.browse({
      w: 20,
      h: 5
    });
  }, "...and `browse({format:'array'})` returns an array as expected", 3, function(nestag) {
    return nestag.browse({
      format: 'array'
    }).length;
  }, "`coord` exceptions", tudor["throw"], "coord must be valid", "/nestag/src/Nestag.litcoffee Nestag::browse()\n  config.coord fails ^[a-z]{0,9999}$", function(nestag) {
    return nestag.browse({
      coord: '!'
    });
  }, "Must supply a coord which exists", "/nestag/src/Nestag.litcoffee Nestag::browse()\n  coord 'x' does not exist", function(nestag) {
    return nestag.browse({
      coord: 'x'
    });
  }, "For an empty Nestag instance, `browse()` throws an error...", "/nestag/src/Nestag.litcoffee Nestag::browse()\n  coord '' does not exist", function() {
    return (new Nestag).browse();
  }, "...and `browse({format:'array'})` also throws an error", "/nestag/src/Nestag.litcoffee Nestag::browse()\n  coord '' does not exist", function() {
    return (new Nestag).browse({
      format: 'array'
    }).length;
  }
...
tudor.add([
  "06 Nestag::add()", tudor.is, "`add()` is a function which returns a string or an array", function() {
    return [new Nestag];
  }, "`add()` is a function", oo.F, function(nestag) {
    return nestag.add;
  }, "`add()` returns a string (the coord of the added cargo’s Location)", oo.S, function() {
    return (new Nestag).add();
  }, tudor.equal, "`add()` returns the empty string, which is the root (level-0) coord", '', function() {
    return (new Nestag).add();
  }, "`config` usage", "First, the number `1` can be added to a level-1 coord", ".--.----a-------.\n|n1:            |\n|  :            |\n'=='============'", function(nestag) {
    nestag.add({
      coord: 'a',
      cargo: [1]
    });
...
if (oo.ROBUSTABLE) {
  tudor.add([
    "91 Robust Location Constructor", tudor.is, "Class members are immutable in modern UAs", function() {
      return [
        new Location({
          nestag: new Nestag,
          coord: 'a'
...
if (oo.ROBUSTABLE) {
  tudor.add([
    "92 Robust Nestag Constructor", tudor.is, "Class members are immutable in modern UAs", function() {
      return [new Nestag];
      ...
      nestag.C = 'changed!';
      return nestag.C;
    }, "`Nestag::grid` cannot be changed after instantiation", '3x3x3', function() {
      var n;
      n = new Nestag({
        grid: [3, 3, 3]
      });
      n.grid[1] = 50;
      return n.grid.join('x');
    }, "`Nestag::grid` elements cannot be changed after instantiation", '100', function() {
      var n;
      n = new Nestag({
        grid: [100]
      });
      n.grid = 'nope';
      return n.grid.join('x');
    }, "`Nestag::nest` cannot be changed after instantiation", 123, function() {
      var n;
      n = new Nestag({
        nest: 123
      });
      n.nest = 456;
      return n.nest;
    }, "`Nestag::scheme` cannot be changed after instantiation", 'dimensional', function() {
      var n;
      n = new Nestag({
        scheme: 'dimensional'
      });
      n.scheme = 'continuous';
      return n.scheme;
    }, "`Nestag::form` cannot be changed after instantiation", 'long', function() {
      var n;
      n = new Nestag({
        form: 'long'
      });
