...
var Nestag, SomeClass, Tudor, oo, tudor, x, xx,
...
tudor.add([
  "01 Nestag Constructor", tudor.is, "The class and instance are expected types", function() {
    ...
    return nestag.C;
  }, "`Nestag::C` is a constant", 'Nestag', function(nestag) {
    nestag.C = 'changed!';
    return nestag.C;
  }, "`Nestag::toString()` is '[object Nestag]'", '[object Nestag]', function(nestag) {
    return nestag + '';
  }, "Instance properties as expected", tudor.equal, "An instance has enumerable properties as expected", '{"x":123}', function(nestag) {
    return JSON.stringify(nestag);
  }, "`Nestag::x` is the number `123`", 123, function(nestag) {
    return nestag.x;
